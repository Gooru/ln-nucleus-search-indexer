...
public final class EntityAttributeConstants {
  ...
  public static final String CONTENT_SUB_FORMAT = "content_subformat";
  ...
  public static final String SUBJECT_CLASSIFICATION = "taxonomy_subject_classification_id";
