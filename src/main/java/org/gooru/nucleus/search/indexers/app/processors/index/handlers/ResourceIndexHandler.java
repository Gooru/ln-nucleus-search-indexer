...
public class ResourceIndexHandler extends BaseIndexHandler implements IndexHandler {
	...
	private Map<String, Object> getScoreValues(String resourceId){
		...
		scoreFieldsValues.put(ScoreConstants.RESOURCE_URL_FIELD, result.get(ScoreConstants.RESOURCE_URL_FIELD));
		scoreFieldsValues.put(ScoreConstants.DESCRIPTION_FIELD, result.get(ScoreConstants.DESCRIPTION_FIELD));
