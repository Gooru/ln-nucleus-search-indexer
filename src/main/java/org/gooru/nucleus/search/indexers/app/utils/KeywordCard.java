 ...
 */
public final class KeywordCard implements Comparable<KeywordCard> {
     ...
     * @param stem
     */
    public KeywordCard(String stem) {
        this.stem = stem;
    }
     ...
     */
    @Override
    public int compareTo(KeywordCard keyword) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof KeywordCard)) return false;

        KeywordCard that = (KeywordCard) o;
