...
public class ValidationUtil {
	...
	public static final Logger LOGGER = LoggerFactory.getLogger(ValidationUtil.class);
	  ...
	  public static void rejectIfInvalidEventJson(JsonObject json) throws InvalidRequestException {
		  if(json == null || json.getJsonObject(EventsConstants.EVT_CONTEXT_OBJECT) == null || json.getJsonObject(EventsConstants.EVT_PAYLOAD_OBJECT) == null || json.getJsonObject(EventsConstants.EVT_PAYLOAD_OBJECT).isEmpty()) {
