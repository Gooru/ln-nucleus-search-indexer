...
@Table(SchemaConstants.GUT_BASED_COLLECTION_SUGGEST)
@IdName(SchemaConstants.ID)
public class GutBasedCollectionSuggest extends Model {

  public final static String FETCH_SUGGESTION_BY_C_OR_MC = "competency_internal_code = ? or micro_competency_internal_code = ?";

  public final static String INSERT_QUERY = "insert into gut_based_collection_suggest (competency_internal_code,micro_competency_internal_code,"
