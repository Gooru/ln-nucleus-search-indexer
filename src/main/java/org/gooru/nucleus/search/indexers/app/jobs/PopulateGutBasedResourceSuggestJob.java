...
public class PopulateGutBasedResourceSuggestJob extends BaseIndexService implements JobInitializer {
  ...
  private static final String FILTER =
          "{ \"bool\" : { \"must\" : [ { \"term\" : { \"contentFormat\" : \"resource\" } }, { \"term\" : { \"publishStatus\" : \"published\" } }, { \"terms\" : { \"taxonomy.allEquivalentInternalCodes\" : [ CROSSWALK_CODES ] } }, { \"term\" : { \"statistics.statusIsBroken\" : 0 } } ] } }";
