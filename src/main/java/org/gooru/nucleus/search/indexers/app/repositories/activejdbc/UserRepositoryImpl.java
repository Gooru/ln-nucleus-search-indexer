...
public class UserRepositoryImpl implements UserRepository {
	...
	public JsonObject getUser(String userID) {
		...
		String[] attributes = { "id", "firstname", "lastname", "email_id", "parent_user_id", "user_category", "created_at", "updated_at", "last_login", "birth_date", "grade", "thumbnail_path",
				"gender", "school_id", "school_district_id", "country_id", "state_id" };
