...
public class GutIndexServiceImpl implements GutIndexService {

  public static final Logger INDEX_FAILURES_LOGGER = LoggerFactory.getLogger("org.gooru.nucleus.index.failures");
  private static final Logger LOGGER = LoggerFactory.getLogger(GutIndexServiceImpl.class);
  
  @Override
  public void deleteIndexedGut(String key, String type) throws Exception {
    try {
      LOGGER.debug("GISI->deleteIndexedGut : Processing delete gut id : " + key);
