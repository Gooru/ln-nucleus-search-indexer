  ...
  public void updateRQCACULLearningMaps(Map<String, Object> data) {
    ...
    try {
      ...
      db.exec(LearningMaps.UPDATE_RQCACUL_QUERY, 
              ...
              data.containsKey("ext_collection_count") ? data.get("ext_collection_count") : 0, 
              data.containsKey("ext_assessment_count") ? data.get("ext_assessment_count") : 0, 
              data.containsKey("offline_activity_count") ? data.get("offline_activity_count") : 0, 
              ...
              data.containsKey("ext_assessment") ? data.get("ext_assessment") : null, 
              data.containsKey("ext_collection") ? data.get("ext_collection") : null, 
              data.containsKey("offline_activity") ? data.get("offline_activity") : null, 
