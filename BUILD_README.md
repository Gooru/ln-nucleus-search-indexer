Building nucleus-search-indexer
==============
...
> java -classpath ./build/libs/nucleus-search-indexer-0.1-snapshot-fat.jar: -Dvertx.logger-delegate-factory-class-name=io.vertx.core.logging.SLF4JLogDelegateFactory io.vertx.core.Launcher -conf src/main/resources/nucleus-search-indexer.json -cluster -instances 4
